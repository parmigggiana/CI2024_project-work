...
from symreg.util_functions import (build_fitness_func, early_stop,
                                   fine_tune_constants)
from symreg.util_functions import live_plot as live_plot_fn
...
INSTANCES = {
    0: {
        ...
        "FITNESS_FUNCTION": lambda ind, mse: 1 / mse - 1e4 * len(ind.nodes),
    },
    1: {
        "POPULATION_SIZE": 100,
        "MAX_DEPTH": 4,
        ...
        "FITNESS_FUNCTION": lambda ind, mse: 1 / mse - 1e3 * len(ind.nodes),
    },
    2: {
        "POPULATION_SIZE": 700,
        "MAX_DEPTH": 5,
    ...
    4: {
        ...
        "FITNESS_FUNCTION": lambda ind, mse: 1 / mse - 0.1 * len(ind.nodes),
    },
    5: {
